...
# lecture = input("Please enter lecture: ")
# def studentsInClass(day, lecture):
#     print(f"Day {}: Students in SRE class\n lecture: {lecture}\nShu\nThomas\nGustavo\nAlim")

# studentsInClass(day, lecture)
...
My name is {first} {last}. I have served as a science teacher at Parktown High School for the past fifteen years and have had the privilege to serve as Ryan Thomas’s teacher for the past three. I have also been Ryan’s advisor on the science academic team here at school. Due to his qualifications, I feel that Ryan would be an excellent addition to your school.
...
recLetter(first_input, last_input)
